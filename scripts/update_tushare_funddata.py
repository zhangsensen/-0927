...
# 43 ETFs from combo_wfo_config.yaml
SYMBOLS = [
    "159801", "159819", "159859", "159883", "159915", "159928", "159949",
    "159992", "159995", "159998", "510050", "510300", "510500", "511010",
    "511260", "511380", "512010", "512100", "512400", "512480", "512660",
    "512690", "512720", "512800", "512880", "512980", "513050", "513100",
    "513130", "159920", "513500", "515030", "515180", "515210", "515650",
    "515790", "516090", "516160", "516520", "518850", "518880", "588000",
    "588200",
]
    ...
    def run_update(self, full: bool = False):
        ...
        for i, sym in enumerate(sorted(SYMBOLS), 1):
            ...
            if s_new > 0 or n_new > 0:
                ...
                status = "up to date"
            logger.info(f"  [{i:2d}/43] {sym}: {status} (share={s_total}, nav={n_total})")
