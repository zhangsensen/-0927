...
class CacheCleaner:
    ...
    def __init__(self, base_dir: str = None):
        ...
        self.backup_dir = self.base_dir / "cache_backup" / datetime.now().strftime("%Y%m%d_%H%M%S")
    ...
    def clear_storage_caches(self) -> bool:
        ...
        try:
            ...
            pycache_patterns = [
                ...
                self.base_dir / "factor_system" / "factor_engine" / "factors" / "__pycache__",
                self.base_dir / "factor_system" / "factor_engine" / "factors" / "etf_cross_section" / "__pycache__",
                self.base_dir / "factor_system" / "factor_engine" / "providers" / "__pycache__",
            ]
            ...
            logger.info(f"存储缓存清理完成: {cleared_count} 项, {cleared_size / (1024*1024):.2f} MB")
            return True
    ...
    def clear_dynamic_factor_caches(self) -> bool:
        ...
        try:
            ...
            dynamic_cache_patterns = [
                self.base_dir / "factor_system" / "factor_output" / "etf_cross_section" / "dynamic_factors",
                self.base_dir / "factor_system" / "factor_output" / "etf_cross_section" / "factor_cache",
                self.base_dir / "factor_system" / "factor_output" / "etf_cross_section" / "factor_metadata",
            ]
            ...
            logger.info(f"动态因子缓存清理完成: {cleared_count} 项, {cleared_size / (1024*1024):.2f} MB")
            return True
    ...
    def reset_global_registry(self) -> bool:
        ...
        try:
            ...
            # 重置因子注册表全局实例
            registry_file = self.base_dir / "factor_system" / "factor_engine" / "factors" / "etf_cross_section" / "factor_registry.py"
            ...
            if registry_file.exists():
                ...
                if hasattr(registry_module, '_global_registry'):
                    ...
                    registry_module._global_registry = registry_module.ETFFactorRegistry()
...
def main():
    ...
    parser.add_argument('--dry-run', action='store_true', help='仅显示将要清理的内容，不实际执行')
