...
def main():
    ...
    df_filtered['rank_dd'] = df_filtered['max_dd'].rank(pct=True) # Higher is better (closer to 0)
    ...
    print(top_200[['combo', 'ann_return', 'max_dd', 'sharpe', 'ret_2022', 'ret_2024', 'score']].head(10).to_markdown())
