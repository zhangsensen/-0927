...
def main():
    ...
    try:
        ...
        plt.scatter(df['rank_v0'], df['rank_v3'], alpha=0.1, s=1, c='gray', label='Others')
        plt.scatter(robust_kings['rank_v0'], robust_kings['rank_v3'], c='green', s=10, label='Robust Kings')
        plt.scatter(new_comers['rank_v0'], new_comers['rank_v3'], c='blue', s=10, label='New Comers')
        plt.scatter(fallen_angels['rank_v0'], fallen_angels['rank_v3'], c='red', s=10, label='Fallen Angels')
    ...
    q_defensive = top300[(top300['ret_2022'] > 0) & (top300['ret_2024'] < 0.20) & (top300['ret_2022'] <= 0.20)]
