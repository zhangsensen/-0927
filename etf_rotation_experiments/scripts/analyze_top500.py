...
file_path = "/home/sensen/dev/projects/-0927/etf_rotation_experiments/results_combo_wfo/20251116_151853_20251124_183803/top500_profit_backtest_slip5bps_20251116_151853_20251124_183803.csv"
...
if len(balanced_df) > 0:
    ...
    best_custom = balanced_df.sort_values('custom_score', ascending=False).head(1)
    
    print("\n🏆 Best 'Golden' Strategy (Custom Score):")
