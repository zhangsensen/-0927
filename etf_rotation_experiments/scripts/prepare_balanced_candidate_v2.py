...
input_file = base_path / "ranking_ml_100_200.parquet"
output_file = base_path / "balanced_candidate.parquet"

df = pd.read_parquet(input_file)
target_combo = "MOM_20D + RSI_14 + VOL_RATIO_20D + VOL_RATIO_60D + VORTEX_14D"
...
if len(subset) == 0:
    ...
    print(f"Saved balanced candidate to {output_file}")
    print(subset.iloc[0])
