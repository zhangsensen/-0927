...
from etf_rotation_optimized.core.utils.rebalance import shift_timing_signal
from strategy_auditor.core.engine import GenericStrategy, PandasData, INITIAL_CAPITAL, COMMISSION_RATE
...
def run_audit(input_file: str, output_file: str = None, top_n: int = None):
    ...
    base_dir = Path("strategy_auditor/results")
