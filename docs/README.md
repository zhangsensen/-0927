...
| 特性 | 说明 |
|------|------|
| **标的池** | 43 只核心 ETF（流动性 Tier1） |
| **因子库** | 18 个因子（趋势/动量/波动/资金流） |
| **组合空间** | 12,597 个 5 因子组合 |
...
┌─────────────────────────────────────────────────────────────┐
│                    WFO 筛选层                                │
│  run_unified_wfo.py - Numba 加速，2.5s 完成 12,597 组合      │
...
│
├── strategy_auditor/           # BT 审计模块
│   └── core/engine.py          # GenericStrategy
│
├── configs/                    # 全局配置
...
python etf_rotation_optimized/run_unified_wfo.py
...
# 可选: VEC/BT 对比验证单个组合
python scripts/full_vec_bt_comparison.py --combo "ADX_14D + CMF_20D + ..."
```
