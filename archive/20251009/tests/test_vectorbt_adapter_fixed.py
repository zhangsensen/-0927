...
def test_vectorbt_adapter_fixed():
    ...
    # 测试MACD
    try:
        macd = adapter.calculate_macd(price, fast_period=12, slow_period=26, signal_period=9)
    ...
    # 测试STOCH
    try:
        stoch = adapter.calculate_stoch(high, low, price, fastk_period=5, slowk_period=3, slowd_period=3)
