...
class MINUS_DI(BaseFactor):
    ...
    category = "technical"
    description = "MINUS_DI技术指标（VectorBT实现）"
    ...
    def calculate(self, data: pd.DataFrame) -> pd.Series:
        """
        计算MINUS_DI - 使用VectorBT确保与factor_generation一致
        ...
        return adapter.calculate_minus_di(high, low, close, timeperiod=self.period)