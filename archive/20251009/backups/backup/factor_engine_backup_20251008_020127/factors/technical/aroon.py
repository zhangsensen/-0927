...
class AROON(BaseFactor):
    ...
    category = "technical"
    description = "AROON技术指标（VectorBT实现）"
    ...
    def calculate(self, data: pd.DataFrame) -> pd.Series:
        """
        计算AROON - 使用VectorBT确保与factor_generation一致
        ...
        return adapter.calculate_aroon(high , low, timeperiod=self.period)
