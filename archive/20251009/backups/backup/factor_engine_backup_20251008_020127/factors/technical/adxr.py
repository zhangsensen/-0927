...
class ADXR(BaseFactor):
    ...
    category = "technical"
    description = "ADXR技术指标（VectorBT实现）"
    ...
    def calculate(self, data: pd.DataFrame) -> pd.Series:
        """
        计算ADXR - 使用VectorBT确保与factor_generation一致
        ...
        return adapter.calculate_adxr(high, low, close, timeperiod=self.period)
