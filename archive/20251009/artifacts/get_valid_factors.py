...
def get_valid_factors():
    ...
    valid_factors = {
        # 移动平均线系列
        "MA", "MA3", "MA5", "MA8", "MA10", "MA12", "MA15", "MA20", "MA25", "MA30", "MA40", "MA50", "MA60", "MA80", "MA100", "MA120", "MA150", "MA200",
        "EMA", "EMA3", "EMA5", "EMA8", "EMA12", "EMA15", "EMA20", "EMA26", "EMA30", "EMA40", "EMA50", "EMA60",
        ...
        # 布林带系列
        "BBANDS", "BB_UPPER", "BB_MIDDLE", "BB_LOWER", "BB_WIDTH",

        # 随机指标系列
        "STOCH", "STOCH_K", "STOCH_D",

        # ATR指标系列
        "ATR", "ATR7", "ATR14", "ATR21", "ATR28",

        # 波动率指标系列
        "MSTD", "MSTD5", "MSTD10", "MSTD15", "MSTD20", "MSTD25", "MSTD30",

        # 成交量指标系列
        "OBV", "OBV_SMA5", "OBV_SMA10", "OBV_SMA15", "OBV_SMA20",
        ...
        "VWAP10", "VWAP15", "VWAP20", "VWAP25", "VWAP30",

        # 威廉指标系列
        "WILLR", "WILLR9", "WILLR14", "WILLR18", "WILLR21",

        # 商品通道指标系列
        "CCI", "CCI10", "CCI14", "CCI20",
        ...
        "SMA", "WMA", "DEMA", "TEMA", "TRIMA", "KAMA", "MAMA", "T3",
        "MIDPOINT", "MIDPRICE", "SAR", "SAREXT",
        "ADX", "ADXR", "APO", "AROON", "AROONOSC", "CCI", "CMO", "DX", "MFI", "MOM",
        "NATR", "OBV", "PLUS_DI", "PLUS_DM", "MINUS_DI", "MINUS_DM", "PPO", "ROC", "ROCP",
        "ROCR", "ROCR100", "STOCHF", "STOCHRSI", "TRANGE", "TRIX", "ULTOSC", "WILLR"
    }
...
def main():
    ...
    # 分类显示
    ma_factors = [f for f in valid_factors if f.startswith(("MA", "EMA", "SMA", "WMA", "DEMA", "TEMA", "TRIMA", "KAMA", "MAMA", "T3"))]
    ...
    volume_factors = [f for f in valid_factors if any(x in f for x in ["OBV", "Volume", "VWAP"])]
    ...
    # 其他技术指标
    other_factors = []
    all_category_factors = ma_factors + macd_factors + rsi_factors + bb_factors + stoch_factors + atr_factors + mstd_factors + volume_factors + willr_factors + cci_factors + momentum_factors + position_factors + trend_factors
    ...
    # 保存到文件
    with open('/Users/zhangshenshen/深度量化0927/valid_factor_engine_factors.txt', 'w', encoding='utf-8') as f:
