...
def test_factor_engine_availability():
    ...
    try:
        ...
        # 统计已注册因子
        registry = FactorRegistry(Path("factor_system/research/metadata/factor_registry.json"))
...
def test_factor_adapter():
    ...
    try:
        from hk_midfreq.factor_engine_adapter import BacktestFactorAdapter, get_factor_adapter
