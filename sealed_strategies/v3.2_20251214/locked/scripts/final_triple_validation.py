...
PATH_HOLDOUT = Path(
    "results/holdout_validation_20251214_002747/holdout_validation_results.parquet"
)
# IMPORTANT: train-only rolling summary (end_date=training_end_date) to avoid holdout leakage into the gate.
PATH_ROLLING = Path(
    "results/rolling_oos_consistency_20251214_011500/rolling_oos_summary.parquet"
)
