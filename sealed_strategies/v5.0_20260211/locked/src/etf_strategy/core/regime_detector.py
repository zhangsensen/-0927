...
class RegimeDetector:
    ...
    def detect_regime(
        ...
        for i, date in enumerate(close.index):
            ...
            if pd.isna(ret) or pd.isna(vol):
                ...
                ret > self.bull_return_threshold
                and vol < self.bull_vol_threshold
                and sharpe > self.bull_sharpe_threshold
            ):
    ...
    def get_regime_periods(
        self, regime: pd.Series, target_regime: MarketRegime
...
if __name__ == "__main__":
    ...
    recent = metrics.tail(30)[
        ["market_index", "rolling_return", "rolling_vol", "rolling_sharpe", "regime"]
    ]
