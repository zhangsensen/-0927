...
def test_imports():
    ...
    try:
        ...
        from etf_data.config import load_config, setup_environment

        print("✅ 配置模块导入成功")

        from etf_data.core.models import DownloadResult, ETFInfo
...
def test_config():
    ...
    try:
        from etf_data import ETFConfig
...
def test_etf_list():
    ...
    try:
        from etf_data import ETFListManager
...
def test_data_manager():
    ...
    try:
        from etf_data import ETFConfig, ETFListManager
        from etf_data.core.data_manager import ETFDataManager
...
def test_environment():
    ...
    try:
        from etf_data.config.etf_config import setup_environment
