...
def main():
    ...
    try:
        ...
        if processor.enable_resampling:
            cleanup_enabled = processor.config.get('resampling', {}).get('cleanup_temp', True)
        ...
        if stats.processed_stocks > 0:
            avg_factors_per_stock = stats.total_factors_generated / stats.processed_stocks
            ...
            print(f"   因子生成速度: {stats.total_factors_generated / stats.processing_time:.0f} 因子/秒")
