    ...
    def init_enhanced_calculator(self):
        ...
        try:
            ...
            self.indicator_config = IndicatorConfig(
                ...
                enable_all_periods=indicator_config.get("enable_all_periods", True),
                memory_efficient=indicator_config.get("memory_efficient", False),
            )
            ...
            # 降级为基本计算器
            self.indicator_config = IndicatorConfig(
                enable_all_periods=True, memory_efficient=False
            )
            self.calculator = EnhancedFactorCalculator(self.indicator_config)
