...
class SmartIndicatorAdapter:
    ...
    def compute_optimized_indicators(self, 
                                   df: pd.DataFrame, 
    ...
    def _optimize_parameters(self, 
                           ...
                           low: np.ndarray, 
                           volume: np.ndarray,
                           target: Optional[pd.Series] = None) -> Dict[str, np.ndarray]:
    ...
    def _ic_based_optimization(self, 
                               config: IndicatorConfig,
                               close: np.ndarray,
                               high: np.ndarray, 
                               low: np.ndarray,
                               volume: np.ndarray,
                               target: pd.Series) -> Dict[str, np.ndarray]:
        """基于信息系数的参数优化"""
    ...
    def _experience_based_selection(self, 
                                  config: IndicatorConfig,
                                  close: np.ndarray,
                                  high: np.ndarray,
                                  low: np.ndarray, 
    ...
    def _calculate_ic(self, indicator_values: np.ndarray, target_values: np.ndarray) -> Tuple[float, float]:
        """计算信息系数和IC_IR"""
    ...
    def _compute_single_indicator(self, 
                                config: IndicatorConfig,
                                params: Dict,
                                close: np.ndarray,
                                high: np.ndarray,
    ...
    def _select_diverse_params(self, 
