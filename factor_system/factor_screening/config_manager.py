...
class ConfigManager:
    ...
    def save_config(self, config: Union[ScreeningConfig, BatchConfig], 
                   filename: str, format: str = "yaml") -> Path:
        """保存配置到文件"""
    ...
    def load_config(self, file_path: Union[str, Path], 
                   config_type: str = "screening") -> Union[ScreeningConfig, BatchConfig]:
        """从文件加载配置"""
