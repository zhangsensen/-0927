...
def test_p0_integration():
    ...
    print("\n[1/5] 测试工具模块导入...")
    try:
        from utils.memory_optimizer import (  # noqa: F401
            MemoryOptimizer,
    ...
    try:
        from utils.input_validator import InputValidator, ValidationError  # noqa: F401
    ...
    try:
        from utils.structured_logger import get_structured_logger  # noqa: F401
    ...
    try:
        from utils.backup_manager import get_backup_manager  # noqa: F401
    ...
    if screener.structured_logger:
        try:
            screener.structured_logger.info("P0集成测试", test_status="success")
            print("  ✅ 结构化日志器功能正常")
        except Exception as e:
