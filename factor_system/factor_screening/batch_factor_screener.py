...
class BatchFactorScreener:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.output_root = Path(
            self.batch_config.get("output_root", "./batch_screening_results")
        )
    ...
    def _create_screening_config(self) -> ScreeningConfig:
        ...
        config_dict = {
            ...
            "correlation_threshold": self.batch_config.get(
    ...
    def _screen_single_task(
        ...
        try:
            ...
            result = {
                ...
                "metrics": {
                    name: vars(metrics) for name, metrics in factor_metrics.items()
                },
            }
    ...
    def screen_market(
        self, market: str, timeframes: List[str] = None, limit: int = None
    ) -> Dict[str, Dict[str, Any]]:
        """
        筛选指定市场的所有股票
        ...
        for market in markets:
            ...
            try:
                market_results = self.screen_market(
                    market=market, timeframes=timeframes, limit=limit_per_market
                )
    ...
    def save_results(
        self, results: Dict[str, Any], prefix: str = "batch_screening"
    ) -> Path:
        """
        保存批量筛选结果
    ...
    def print_summary(self):
        ...
        if self.stats.completed_tasks > 0:
            print(
                f"平均每任务: {self.stats.elapsed_time / self.stats.completed_tasks:.2f} 秒"
            )
        print("=" * 60)
