...
from utils.temporal_validator import TemporalValidator, validate_factor_return_alignment
from utils.time_series_protocols import SafeTimeSeriesProcessor, safe_ic_calculation
from scripts.check_future_functions import check_file_for_future_functions
...
class TestEdgeCases:
    ...
    def test_all_nan_data(self):
        ...
        nan_series = pd.Series([np.nan] * 10, index=pd.date_range('2023-01-01', periods=10))
